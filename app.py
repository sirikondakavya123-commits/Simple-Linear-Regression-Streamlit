...
st.markdown(
    ...
    <div class="card">
        ...
        <p>
            Predict <b>Tip Amount</b> from <b>Total Bill</b> using Linear Regression...
        </p>
    </div>
    """,
...
st.markdown(f"""
        ...
        <h3>Model Intercept & Coefficient</h3>
            ...
            <b>Intercept:</b>{model.intercept_:.3f}</f></p>
        </div> 
            """,unsafe_allow_html=True)
...
st.markdown(f'''<div class="prediction-box">Predict Tip:${tip:.2f}</div>
            ''',unsafe_allow_html=True)
st.markdown('</sdiv>',unsafe_allow_html=True)
